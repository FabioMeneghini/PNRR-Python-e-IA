...
st.sidebar.text_input('Scrivi qui il tuo testo', key='text_input_sidebar')
st.sidebar.text_area('Scrivi qui il tuo testo', key='text_area_sidebar')
st.sidebar.button('Invia', key='button_sidebar')
st.sidebar.checkbox('Accetta i termini e le condizioni', key='checkbox_sidebar')
